...
TLX_SENSOR_TYPES: tuple[GrowattSensorEntityDescription, ...] = (
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_generation_total_input_1",
        translation_key="tlx_solar_generation_total_input_1",
        api_key="epv1Total",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_generation_today_input_1",
        translation_key="tlx_solar_generation_today_input_1",
        api_key="epv1Today",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_generation_total_input_2",
        translation_key="tlx_solar_generation_total_input_2",
        api_key="epv2Total",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_generation_today_input_2",
        translation_key="tlx_solar_generation_today_input_2",
        api_key="epv2Today",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_generation_total_input_3",
        translation_key="tlx_solar_generation_total_input_3",
        api_key="epv3Total",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_generation_today_input_3",
        translation_key="tlx_solar_generation_today_input_3",
        api_key="epv3Today",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_generation_total_input_4",
        translation_key="tlx_solar_generation_total_input_4",
        api_key="epv4Total",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    GrowattSensorEntityDescription(
        key="tlx_solar_generation_today_input_4",
        translation_key="tlx_solar_generation_today_input_4",
        api_key="epv4Today",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
